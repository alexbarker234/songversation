  ...
  return (
    <div className="relative">
      <div className="absolute left-0 right-0 top-0 flex justify-center">
        <div className="flex items-center space-x-4 rounded-b-lg bg-gray-800 px-4 py-2 shadow-lg">
          <div className="text-sm">
            <span className="font-medium">You:</span> {userName}
          </div>
          <div className="text-sm">
            <span className="font-medium">Opponent:</span> {peer.name}
          </div>
          <div className="text-sm">
            <span className="font-medium">Opponent Score:</span> {peer.score}
          </div>
        </div>
      </div>
